...
from turtlesim.msg import Pose # get Pose topic
from geometry_msgs.msg import Twist # get Twist topic
from my_first_package_msgs.msg import CmdAndPoseVel  # get data structure
...
class CmdAndPose(Node):
    ...
    # get subscribed data from cmd_pose
